...
\subsusubbsection{Aus Textfeld}
Hierbei wird die Parameterliste eines Osmosis Aufrufs z.B. ``--read-xml foo.osm --bb left=8 right=8.4 top=49 bottom=48 --write-xml bar.osm'' vom Benutzer in ein
Textfeld eingegeben oder hineinkopiert und nach klick auf OK von OsmUi als Pipeline geladen.
\subsubsubsection{Aus Zwischenablage}
...
\subsubsubsection{Aus Aufrufskripten}
...
\newline
6 bestätigt die mit klick auf Button ''Öffnen''.
\newline
