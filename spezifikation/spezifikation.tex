...
\hline Sonfall 4a) & Die Pipelinei wurde noch nie gespeichert
...
\newline 8 OsmUi zeigt wieder die aktuelle Pipeline\\
...
\newline 6 OsmUi zeigt wieder die aktuelle Pipeline\\
\hline
\end{tabular}
\end{center}
...
\hline Nachbedingung & Die Datei wurde ins gewählte Verzeichnis exportiert\\ 
\hline Nachbedingung im Sonderfall 4a) & Die Datei wurde nicht importiert\\
\hline Nachbedingung im Sonderfall 5a)& Die Datei wurde nicht importiert\\ 
\hline Nachbedingung im Sonderfall 5b)& Die Datei wurde nicht importiert\\
\hline Nachbedingung im Sonderfall 6a)& Die Datei wurde nicht importiert\\ 
\hline Akteur & Benutzer \\ 
\hline Normalablauf & 1 Der Benutzer klickt auf Datei
\newline 2 OsmUi zeigt den Menüeintrag Datei
\newline 3 Der Benutzer klickt auf Datei exportieren
\newline 4 OsmUi zeigt den Dateiauswahldialog
\newline 5 Der Benutzer wählt den gewünschten Namen und die Dateiendung aus
...
\newline Der Benutzer klickt auf OK
\newline OsmUi zeigt die momentane pipeline an\\
\hline Sonderfall 5a) & 5a.1 Der Benutzer klickt auf Abbrechen\\
\hline Sonderfall 5b) & 5b.1 Der Benutzer klickt auf eine bereits vorhandene Datei
\newline 5b.2 OsmUi fragt, ob die Datei überschrieben werden soll
\newline 5b.3 Der Benutzer klickt auf Ja
...
\\
\begin{tabular}{|p{5cm}|p{10cm}|}
\hline Begriff & \textbf{Pipeline inkonsistent} \\ 
\hline Bedeutung & Eine Pipeline ist inkonsistent wenn es Tasks mit unverbundenen Eingängen gibt \\ 
\hline Abgrenzung & Eine konsistente Pipeline, also eine die nicht inkonsistent ist, muss nicht von Osmosis ausführbar sein
