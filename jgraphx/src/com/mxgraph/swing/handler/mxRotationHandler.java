...
public class mxRotationHandler extends mxMouseAdapter
{
	...
	static
	{
		ROTATE_ICON = new ImageIcon(mxRotationHandler.class
	...
	public void mousePressed(MouseEvent e)
	{
		if (currentState != null && handle.getParent() != null
				&& e.getSource() == handle /* mouse inside handle */)
		{
			start(e);
			e.consume();
		}
	...
	public void mouseMoved(MouseEvent e)
	{
		...
		{
			if (handle.getParent() != null && e.getSource() == handle /* mouse inside handle */)
			{
	...
	public void mouseDragged(MouseEvent e)
	{
				...
				&& first != null)
		{
			...
			Point pt = SwingUtilities.convertPoint(e.getComponent(), e
					.getPoint(), graphComponent.getGraphControl());
			...
			// FIXME: Initial angle must be computed here
	...
	public void paint(Graphics g)
	{
		if (currentState != null && first != null)
		{
			...
			if (deg != 0)
			{
				((Graphics2D) g).rotate(Math.toRadians(deg), currentState
						.getCenterX(), currentState.getCenterY());
			}
