...
\section{Usabillity Patterns}
Um die Verwendung von OsmUi für den Benutzer so komfortabel wie möglich zu gestalten, werden einige Usabillity Patterns verwendet
...
\subsection{Filter}
Um dem Benutzer die Erstellung einer korrekten Pipeline zu vereinfachen, werden in der Taskbox nur die kompatiblen Tasks angezeigt. Ebeno können in der Pipelinebox nur kompatible Tasks angehängt werden.
\subsection{gute Standardwerte}
Damit der Benutzer möglichst wenige Werte eingeben muss, werden die Parameter eines Tasks zuerst mit sinnvollen Standardwerten gefüllt. Diese kann der Benutzer selbs ändern.
...
\hline Sonderfall 2a) & 2a.1 Der Benutzer klickt rechts auf einen Task in der Pipelinebox
\newline 2a.2 OsmUi zeigt den Punkt \glqq anfügen''
\newline 2a.3 Der Benutzer wählt \glqq anfügen''
\newline 2a.4 Der Task wird an den selektierten Task a\\ngefügt\\
\hline Sonderfall 2a2a) & Der Punkt \glqq anfügen'' ist ausgegraut
\newline $ \rightarrow$ Schritt 2\\
\hline
\end{tabular}
\end{center}
...
\hline Nachbedingung im Sonderfall 4b) & Die Parameter wurden geändert?\\
\hline Akteur & Benutzer \\ 
...
\item Version 1.3 - Hinzufügen von Usabillity Patterns (11.12.10)
\end{itemize}
\end{document}
